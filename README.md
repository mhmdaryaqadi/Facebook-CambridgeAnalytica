...
*   **Tautan Video Dokumentasi YouTube (Unlisted):** https://youtu.be/jOqH1RyA9Tg
...
*   **Muhammad Arya Alqadi (4524210058):** Sebagai calon profesional informatika, saya berkomitmen untuk memprioritaskan transparansi tata kelola data di atas target performa bisnis korporasi. Apabila nanti memegang peran kepemimpinan teknis, saya akan menolak secara tegas segala bentuk instruksi manajemen yang mengarah pada penyembunyian cacat arsitektur sistem (concealment of defect) karena dapat merugikan hak privasi masyarakat luas.
*   **Muzakki Abrar (4524210071):** Kasus ini menjadi pelajaran penting bagi saya untuk selalu menjaga watak kebajikan (virtue ethics) dalam setiap fase pengembangan sistem. Saya berkomitmen untuk menjunjung tinggi kejujuran profesional dan menolak perancangan rekayasa antarmuka yang manipulatif (dark patterns) yang dapat mengaburkan validitas informed consent dari subjek data.
*   **Muhammad Jibran Ferdian (4524210067):** Saya berkomitmen untuk menjadikan nilai-nilai luhur Pancasila serta klausul Kode Etik ACM/IEEE sebagai panduan moral utama dalam karier profesional di bidang teknologi informasi. Saya akan memastikan setiap arsitektur perangkat lunak yang saya bangun tetap menghormati martabat manusia dan mencegah potensi bahaya (avoid harm) bagi keharmonisan sosial.
*   **Muhammad Arkan (4524210114):** Dalam karier masa depan di bidang TI, saya berkomitmen untuk mengintegrasikan manajemen risiko berbasis kerangka ISO 31000 secara ketat. Proses identifikasi, kuantifikasi, dan mitigasi terhadap risiko etis teknologi akan saya lakukan sejak fase awal perancangan sistem demi mencegah penyalahgunaan kewenangan digital.
*   **Daffa Richadatul'Aisy (4524210136):** Rencana karier saya ke depan akan difokuskan pada perlindungan hak asasi informasi subjek data demi mewujudkan keadilan sosial digital. Untuk itu, saya berkomitmen penuh untuk memperjuangkan implementasi standar teknis Privacy by Design serta prinsip Data Minimization secara nyata pada setiap basis data yang saya rancang.
